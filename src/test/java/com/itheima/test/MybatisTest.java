...
public class MybatisTest {
  ...
  public void test1() throws IOException {
    ...
    User user = sqlSession.selectOne("com.itheima.mapper.UserMapper.findByCondition", 2);
    System.out.println(user);
    System.out.println("MyBatis源码环境搭建成功...");


    // 4. 委派给Executor来执行，Executor执行时又会调用很多其他组件（参数设置、解析sql的获取，sql的执行、结果集的封装）
//    User user = sqlSession.selectOne("com.itheima.mapper.UserMapper.selectOne", 1);

//    User user1 = new User();
//    user1.setId(1);
//    User user = sqlSession.selectOne("com.itheima.mapper.UserMapper.findUserById", user1);
//    System.out.println(user);
//    System.out.println("MyBatis源码环境搭建成功....");
